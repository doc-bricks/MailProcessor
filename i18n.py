...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "page_paths_field_name": {"de": "{} - Skriptpfad",                      "en": "{} - script path"},
    "page_paths_field_desc": {"de": "Pfad zum Startskript für {}. Leer lassen, um das Tool jetzt nicht einzurichten.",
                              "en": "Path to the launch script for {}. Leave empty to skip this tool for now."},
    "page_paths_browse_name":{"de": "{} - Durchsuchen",                     "en": "{} - Browse"},
    "page_paths_browse_desc":{"de": "Dateidialog öffnen, um das Python-Skript für {} auszuwählen.",
                              "en": "Open the file picker to choose the Python script for {}."},
    "page_paths_browse_tip": {"de": "Python-Skript für {} auswählen",       "en": "Select Python script for {}"},
    ...
    "btn_rescan_tip":        {"de": "Nach lokal installierten Mail-Tools suchen", "en": "Scan for locally installed Mail Tools"},
    "tool_table_desc":       {"de": "Übersicht der konfigurierten Mail-Tools mit aktuellem Status und Skriptpfad", "en": "Overview of configured Mail Tools with current status and script path"},
    "tray_unavailable":      {"de": "Der System-Tray ist auf diesem System nicht verfügbar.", "en": "System tray is not available on this system."},
